...
function Festival() {
  return (
    <div className="p-2 bg-[var(--color-brand)] text-white text-left">
        ...
        <h2 className="text-xl md:text-3xl text-[var(--color-primary)] font-bold mb-4 my-4">▶ LE PROJET MARS AI<hr /></h2>
        ...
        <h2 className="text-3xl font-bold mb-4 text-[var(--color-primary)]">▶ LES FILMS EN COMPÉTITION<hr /></h2>
            ...
            <MoviesThumbnails />
            <NavLink to={"/submit"}><h2 className="text-xl text-white bg-[var(--color-secondary)] text-center w-40 flex m-auto p-2 rounded-xl">Voir tous les films</h2></NavLink>
        ...
        <div className='my-10  bg-[var(--color-brand)] p-5 rounded-2xl'>
            ...
            <div className='flex flex-col lg:flex-row lg:justify-around justify-center items-center gap-5 mt-5'>
                ...
                <NavLink to={"/submit"}><h2 className="text-xl my-8 text-white bg-[var(--color-secondary)] text-center w-40 m-auto p-2 rounded-xl">Participer</h2></NavLink>
        </div>
        <div className='my-10  bg-[var(--color-brand)] p-5 rounded-2xl'>
            <h2 className="text-3xl font-bold mb-4 text-[var(--color-primary)]">▶ DEUX JOURNÉES DE CONFÉRENCES GRATUITES<hr /></h2>
        ...
        <h2 className="text-3xl font-bold mb-4 text-[var(--color-primary)] p-5">▶ MARS A.I. NIGHT<hr /></h2>
        <div className='flex flex-col justify-center p-5 my-10 m-auto w-100 bg-gradient-to-b from-[#e5a50a] to-[#c64600] rounded-2xl border-black shadow-lg/50 shadow-white'>
                ...
                <p className="text-white text-center md:text-4xl/16">13 juin</p>
                <p className="text-white text-center md:text-2xl/18">À partir de 19h</p>
                <p className="text-white text-center md:text-2xl/16">Fête Électro mêlant IA et futurs souhaitables.</p>
                <p className="text-white text-center md:text-2xl/18">Une expérience immersive sonore et visuelle.</p>
            <NavLink to={"/submit"}><h2 className="text-xl my-8 text-white bg-[var(--color-secondary)] text-center w-40 m-auto p-2 rounded-xl"> Obtenir mon pass</h2></NavLink>
            </div>
            <div className=''>
                <h2>Le Lieu</h2>
                <h3>LA PLATEFORME</h3>
                <h3>(ex Docks des Suds)</h3>
                <p>4 000 m² d'espaces modulables dans le centre de Marseille, au cœur de l'écosystème numérique.</p>
                <h2>Salle des Sucres</h2>
                ...
                <h2>Salle Plaza</h2>
                <p>L'épicentre du festival : accueil, animations, workshops et restauration. Le point de rencontre de tous les participants.</p>
                <img src="/marsai.png" alt="Festival Marsai" className="w-full m-auto"/>
            </div>
        </div>
  )
}
