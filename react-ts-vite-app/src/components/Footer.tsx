    ...
    return (
        ...
        <div className="bg-[var(--color-brand)] text-white">
            <div className="p-10 text-center flex flex-col items-center gap-10 md:gap-0 lg:flex-row md:justify-around">
                <div className="text-left border-2 border-white p-12 rounded-4xl">
                    <NavLink to={"/"}><p className="text-3xl bg-[var(--color-primary)] p-2 rounded-tr-2xl">MarsAI</p></NavLink>
