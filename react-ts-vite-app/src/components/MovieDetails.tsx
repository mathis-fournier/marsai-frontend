...
function MovieDetails() {
  ...
  useEffect(() => {
    ...
    const fetchMovieCollaborators = async () => {
      ...
      try {
        const response = await fetch(
          `${import.meta.env.VITE_API_URL}/movies/${id}/collaborators`,
        );
        if (!response.ok) {
          throw new Error(
            t("movie_details.error_status", { status: response.status }),
  ...
  return (
    <div className="flex justify-center items-center p-6 bg-(--color-background) min-h-screen">
      <div className="bg-brand2 m-auto p-10 font-bold rounded-2xl ">
        {/* TITRE DU FILMS */}
        <div className="bg-brand2 m-auto p-10 font-bold">
          <h1 className="text-center bg-linear-to-r from-secondary to-red-800 bg-clip-text text-transparent text-4xl/20 ">
            {movieDetails[0].english_title}
          </h1>
          <h2 className="text-center bg-linear-to-r from-secondary to-red-800 bg-clip-text text-transparent text-4xl/20 ">
        ...
        <div className="mt-6 ">
          <div className="flex items-center justify-center">
            {movieDetails[0].youtube_url ? (
              <iframe
                width="560"
                height="315"
                src={movieDetails[0].youtube_url}
          ...
          <div className="p-10 my-10 flex flex-col items-center justify-center text-white text-2xl">
            ...
            <button
              className="bg-third text-black hover:bg-secondary text-sm md:text-xl p-5 rounded-xl m-auto block"
              type="submit"
            >
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    <tr>
                      <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                        {t("movie_details.isHybrid")}
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                        {movieDetails[0].isHybrid ? "Yes" : "No"}
                      </td>
                    </tr>
                    <tr>
                      <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                        {t("movie_details.original_language")}
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                        {movieDetails[0].original_language}
                      </td>
                    </tr>
                    <tr>
                      <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                        {t("movie_details.original_synopsis")}
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                        {movieDetails[0].original_synopsis}
                      </td>
                    </tr>
                    <tr>
                      <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                        {t("movie_details.english_synopsis")}
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                        {movieDetails[0].english_synopsis}
                      </td>
                    </tr>
                    <tr>
                      <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                        {t("movie_details.submitted_at")}
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                        {movieDetails[0].submitted_at}
                      </td>
                    </tr>
                    <tr>
                      <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                        {t("movie_details.duration")}
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                    ...
                    <tr>
                      <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                        {t("movie_details.creative_process")}
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                        {movieDetails[0].creative_process}
                      </td>
                    </tr>
                    <tr>
                      <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                        {t("movie_details.ia_tools")}
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                        {movieDetails[0].ia_tools}
                      </td>
                    </tr>
                    <tr>
                      <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                        {t("movie_details.hasSubs")}
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                        {movieDetails[0].hasSubs ? "Yes" : "No"}
                      </td>
                    </tr>
                    <tr>
                      <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                  ...
                  <thead className="bg-gray-50">
                    <tr>
                      <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                        {t("movie_details.collaborator_Firstname")}
                      </th>
                      <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                        {t("movie_details.collaborator_Lastname")}
                      </th>
                      <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                        {t("movie_details.collaborator_Job")}
                      </th>
                      <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                        {t("movie_details.collaborator_Contribution")}
                      </th>
                      <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
