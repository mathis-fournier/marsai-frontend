...
function Header() {
  ...
  return (
    ...
    >
      <div className="font-sans p-4 text-center font-bold text-sm sm:text-sm text-white flex justify-between items-center relative z-10">
        ...
        <div className="text-center text-2xl md:text-4xl md:gap-15 flex flex-col xl:flex-row  p-2 rounded-xl">
          {/* Desktop Navigation */}
          <div ref={navRef} className="hidden font-semi-bold xl:flex xl:flex-row items-center justify-around xl:gap-15 lg:gap-10 md:gap-5 text-left relative">
