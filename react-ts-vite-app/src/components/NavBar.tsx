...
function NavBar() {
  return (
    <div className="p-5 flex justify-between items-center">
        <NavLink to={"/"}><h2 className="text-2xl bg-purple-500 p-2 rounded-xl">Mars A.I.</h2></NavLink>
        ...
        <NavLink to={"/submit"}><h2 className="text-2xl bg-purple-500 p-2 rounded-xl">Soumettre un film</h2></NavLink>
